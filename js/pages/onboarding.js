...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (btnRefresh) {
    btnRefresh.addEventListener('click', async () => {
      ...
      btnRefresh.innerHTML = '<i class="bi bi-hourglass-split" aria-hidden="true"></i> Fetching...';
      ...
      btnRefresh.innerHTML = '<i class="bi bi-arrow-clockwise" aria-hidden="true"></i> Refresh New ID';
    });
  }
