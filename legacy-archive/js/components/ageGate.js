...
export function initAgeGate() {
  ...
  const modalHtml = `
    <div id="age-gate-modal" class="age-gate-backdrop" role="dialog" aria-modal="true" aria-labelledby="age-gate-title"> <div class="age-gate-card"> <div class="age-gate-badge">18+</div> <h2 id="age-gate-title" class="age-gate-title">Before you continue</h2> <p class="age-gate-subtitle">Adults only. Please confirm once to continue.</p> <div class="age-gate-checkbox-box"> <input type="checkbox" id="age-gate-checkbox" class="age-gate-checkbox"> <label for="age-gate-checkbox" class="age-gate-label">
          ...
          </label> </div> <button id="age-gate-btn-continue" class="age-gate-btn-continue" disabled>
          Continue
        </button> <button id="age-gate-btn-leave" class="age-gate-btn-leave">
          Leave
        </button> </div> </div>
  `;
